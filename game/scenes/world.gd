...
# Placed in the SE flat area east of the river (col > 18), away from mountains,
# forests, and deep water. Sprint 12: relocated from (10, 8) to (21, 10).
const VILLAGE_CENTER_COL := 21
const VILLAGE_CENTER_ROW := 10
