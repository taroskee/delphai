...
- [ ] **検証 (3/3 点)**: **人間目視 — Mac で `make build-mac` → Godot 起動 → 住民が対角も含む連続ランダムウォークで滑らかに動く & カメラ pan/zoom が動くことを確認**
- [ ] コミット: `feat(sprint-n4.2): 8-directional (Chebyshev) 1-step movement`（人間目視通過後）
